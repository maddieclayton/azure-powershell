...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Azure','ResourceManager','ARM','Provider','ResourceGroup','Deployment','ActiveDirectory','Authorization','Management','ManagementGroups','Tags','AzPowerShellModule'
        ...
        ReleaseNotes = '* Add ''-TemplateObject'' parameter to deployment cmdlets
