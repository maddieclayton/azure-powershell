...
online version: https://docs.microsoft.com/en-us/powershell/module/az.keyvault/new-azvaultpropertiesobject
schema: 2.0.0
---

# New-AzVaultPropertiesObject

## SYNOPSIS
Cmdlet to create an in-memory instance of the VaultProperties object.

## SYNTAX

### Api20161001 (Default)
```
New-AzVaultPropertiesObject [-AccessPolicies <IAccessPolicyEntry[]>] [-CreateMode <CreateMode>]
 ...
 -SkuName <SkuName> -TenantId <String> [-VaultUri <String>] [<CommonParameters>]
```
...
New-AzVaultPropertiesObject [-AccessPolicies <IAccessPolicyEntry[]>] [-CreateMode <CreateMode>]
 [-EnablePurgeProtection <Boolean>] [-EnableSoftDelete <Boolean>] [-EnabledForDeployment <Boolean>]
 [-EnabledForDiskEncryption <Boolean>] [-EnabledForTemplateDeployment <Boolean>] -SkuFamily <SkuFamily>
 -SkuName <SkuName> -TenantId <String> [-VaultUri <String>] [-NetworkAclsBypass <NetworkRuleBypassOptions>]
...
### Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ModelsApi20161001.IVaultProperties
### Microsoft.Azure.PowerShell.Cmdlets.KeyVault.ModelsApi20180214.IVaultProperties
## NOTES

## RELATED LINKS

[https://docs.microsoft.com/en-us/powershell/module/az.keyvault/new-azvaultpropertiesobject](https://docs.microsoft.com/en-us/powershell/module/az.keyvault/new-azvaultpropertiesobject)
