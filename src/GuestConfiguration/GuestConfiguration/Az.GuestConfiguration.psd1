...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Azure','ResourceManager','ARM','Guest','VmPolicy','VmGuestPolicy','GuestConfiguration','GuestInitiative','GuestConfigurationInitiative','GuestConfigurationPolicy','AzPowerShellModule'
